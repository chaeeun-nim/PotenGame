...
export default function ItemCardImage() {
  return (
    <div className="rounded-md flex justify-center items-center w-[150px] h-[101px] md:w-[229px] md:h-[142px] xl:w-[282px] xl:h-[182px] border-1 border-poten-gray-1 bg-white">
