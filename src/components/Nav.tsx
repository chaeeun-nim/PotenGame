...
export function Nav() {
  return(
    <>
    <div className='border-2 border-poten-gray-1 bg-white sticky top-0'>
      {/* 모바일 하단 네비게이터 */}
      <ul className='flex justify-around fixed bottom-0 w-full md:hidden '>
        <li>
          <Link href={'/'}>
      ...
      {/* 상단 네비게이터 */}
      <ul 
      className='flex p-3  md:p-0 gap-5 whitespace-nowrap overflow-x-scroll [&::-webkit-scrollbar]:hidden md:overflow-visible justify-around items-center max-w-300 m-auto'>
